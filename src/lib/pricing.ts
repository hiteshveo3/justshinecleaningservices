...
export const pricingServices: PricingService[] = [
  ...
  },
  {
    ...
    category: "Residential",
    current: "AED 100/hour",
    original: "AED 150/hour",
    bestFor: "Hidden dust, grout, vents, corners, kitchen grease, and full-home reset",
    scope: "1BR AED 300-400, 3BR villa AED 500-600, 5BR+ AED 700-800",
    rows: [
      { label: "Deep Cleaning", price: "AED 100/hour", original: "AED 150/hour" },
      { label: "1BR Apartment", price: "AED 300-400", original: "AED 450-600", note: "3-4 hours" },
      { label: "2BR Apartment", price: "AED 400-500", original: "AED 600-750", note: "4-5 hours" },
      { label: "3BR Villa", price: "AED 500-600", original: "AED 750-900", note: "5-6 hours" },
      { label: "4BR Villa", price: "AED 600-700", original: "AED 900-1,050", note: "6-7 hours" },
      { label: "5BR+ Villa", price: "AED 700-800", original: "AED 1,050-1,200", note: "7-8 hours" },
    ],
    discounts: [
      { label: "Monthly Contract", price: "AED 80/hour", note: "20% off, 3BR saves AED 110/month" },
      { label: "Quarterly Deep Clean", price: "AED 85/hour", note: "15% off" },
      { label: "Bundle Same Day", price: "AED 85/hour", note: "15% off with carpet or sofa" },
      { label: "Annual Prepay", price: "AED 75/hour", note: "25% off" },
      { label: "Referral Program", price: "AED 95/hour", note: "5% off" },
    ],
  },
  {
    slug: "villa-cleaning",
    ...
    scope: "3BR AED 500-600, 4BR AED 600-700, 5BR+ AED 800-1000",
    rows: [
      { label: "Villa Cleaning", price: "AED 100/hour", original: "AED 150/hour" },
      { label: "3BR Villa", price: "AED 500-600", original: "AED 750-900", note: "5-6 hours" },
      { label: "4BR Villa", price: "AED 600-700", original: "AED 900-1,050", note: "6-7 hours" },
      { label: "5BR Villa", price: "AED 700-800", original: "AED 1,050-1,200", note: "7-8 hours" },
      { label: "5BR+ Villa", price: "AED 800-1000", original: "AED 1,200-1,500", note: "8-10 hours" },
    ],
    discounts: [
      { label: "Monthly Contract", price: "AED 80/hour", note: "20% off, best for villas" },
      { label: "Quarterly Villa + Carpet + Sofa", price: "AED 841.50 example", note: "15% total discount" },
