...
export const pricingServices: PricingService[] = [
  {
    ...
    current: "AED 30-35/hour",
    original: "AED 45/hour",
    bestFor: "Bedrooms, living rooms, bathrooms, and kitchens",
    scope: "AED 30/hour without materials · AED 35/hour with materials · min 2 hours",
    rows: [
      { label: "Without materials", price: "AED 30/hour", original: "AED 45/hour", note: "Labor only" },
      { label: "With materials", price: "AED 35/hour", original: "AED 50/hour", note: "Supplies included" },
      { label: "Minimum booking", price: "2 hours", note: "All hourly services" },
    ...
    discounts: [
      { label: "Monthly Contract", price: "Custom quote", note: "Best rate for weekly/bi-weekly homes" },
      { label: "Same-day booking", price: "No extra fee", note: "When nearby slots are open" },
      { label: "Weekend booking", price: "No surcharge", note: "Subject to availability" },
      { label: "Referral Bonus", price: "Ask on WhatsApp", note: "Share and save together" },
    ],
  },
  {
    slug: "deep-cleaning",
    ...
    scope: "Starts from AED 35/hour with materials · min 2 hours",
    rows: [
      { label: "Deep Cleaning", price: "AED 35/hour", original: "AED 50/hour", note: "With materials" },
      { label: "Minimum booking", price: "2 hours", note: "Then billed hourly" },
      { label: "1BR Apartment", price: "AED 70-140", original: "AED 100-200", note: "2-4 hours" },
      { label: "2BR Apartment", price: "AED 105-175", original: "AED 150-250", note: "3-5 hours" },
      { label: "3BR Villa", price: "AED 175-210", original: "AED 250-300", note: "5-6 hours" },
    ],
    discounts: [
      { label: "Monthly / recurring", price: "Custom quote", note: "Better rate for regular deep cleans" },
      { label: "Bundle same day", price: "Ask on WhatsApp", note: "Carpet or sofa add-on" },
      { label: "Same-day / weekend", price: "No surcharge", note: "When slots are open" },
    ],
  },
  {
    slug: "villa-cleaning",
    ...
    scope: "Starts from AED 35/hour · min 2 hours · all Abu Dhabi areas",
    rows: [
      { label: "Villa Cleaning", price: "AED 35/hour", original: "AED 50/hour", note: "With materials" },
      { label: "Minimum booking", price: "2 hours", note: "Then billed hourly" },
      { label: "3BR Villa", price: "AED 175-210", original: "AED 250-300", note: "5-6 hours" },
    ...
    discounts: [
      { label: "Monthly villa plan", price: "Custom quote", note: "Best for recurring villa care" },
      { label: "Abu Dhabi travel", price: "No extra travel fee", note: "Same rate across Abu Dhabi" },
      { label: "Same-day / weekend", price: "No surcharge", note: "When slots are open" },
    ],
  },
  {
