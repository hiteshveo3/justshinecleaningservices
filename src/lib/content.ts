export const site = {
  ...
  location: "Al Jazeera Towers, Al Danah - Zone 1, Abu Dhabi",
  streetAddress: "Al Jazeera Towers, Al Danah - Zone 1",
  ...
  googleMapsUrl: "https://www.google.com/maps/place/Just+Shine+Cleaning+Services/@24.4917066,54.3650786,17z/data=!3m1!4b1!4m6!3m5!1s0x3e5e67002f41a8a5:0xc0adc04da10963b0!8m2!3d24.4917066!4d54.3650786!16s%2Fg%2F11z2dcf36v",
  googlePlaceCid: "0xc0adc04da10963b0",
  logo: "/brand-mark.png",
  // Official economic licence (Abu Dhabi) — Establishment Date 10/10/2023
  foundingYear: 2023,
  foundingMonth: "October",
  foundingDay: 10,
  foundingDate: "2023-10-10",
  yearsExperience: 2,
  sinceLabel: "Licensed since October 2023",
  tradeName: "JUST SHINE CLEANING SERVICES",
  tradeNameAr: "جست شاين لخدمات التنظيف",
  legalForm: "Sole Establishment",
  licenceCategory: "Abu Dhabi Trader",
  licenceType: "Emerging Economic Establishment",
  licenceActivity: "Buildings Cleaning Services",
  licenceActivityCode: "8121001",
  tradeLicenseNumber: "CN-5067242",
  tradeLicenseLabel: "Licence No. CN-5067242",
  unifiedLicenceNo: "501-2023-100237974",
  unifiedRegistrationNo: "101-2023-100164417",
  adcciNo: "1987733",
  mohreEstablishmentCardNo: "8800058163",
  icpEstablishmentCardNo: "844995",
  licenceIssued: "2025-09-29",
  licenceExpiry: "2026-10-25",
  licenceVerifyUrl: "https://www.tamm.abudhabi",
  licenceAuthorityUrl: "https://www.adra.gov.ae",
  openingHours: "Mo-Su 08:00-22:00",
  openingHoursLabel: "8:00 AM - 10:00 PM daily",
  priceRange: "AED 30-150 per hour",
  priceWithoutMaterials: 30,
  priceWithMaterials: 35,
  materialsExtra: 5,
  minBookingHours: 2,
  weekendSurcharge: false,
  sameDaySurcharge: false,
  travelFeeAbuDhabi: false,
  ecoFriendlyAvailable: true,
  pestControlInHouse: true,
  teamSize: 10,
  ownerName: "Nadhira Karim Bakhsh Ghulam Bakhsh",
  ownerNationality: "United Arab Emirates",
  managerName: "Maika",
  tagline: "Spotless Abu Dhabi homes — clear prices, trained teams, fast WhatsApp booking.",
  rating: {
    value: 4.7,
    count: 12,
    best: 5,
...
export const authors = {
  "just-shine-team": {
    ...
    credentials: [
      "Abu Dhabi licensed cleaning establishment (Licence No. CN-5067242)",
      "Licensed activity: Buildings Cleaning Services (8121001)",
...
export const services: Service[] = [
  {
    ...
    active: true,
    highlights: ["From AED 30 without materials", "AED 35 with materials", "Min 2 hours", "Kitchen cleaning"],
  },
  {
    id: "deep-cleaning",
    slug: "deep-cleaning",
...
/** Only verified 5-star Google reviews are shown (empty/spam/wrong-business reviews excluded). */
export const testimonials = [
  {
    name: "muhammad usman",
    area: "Google review",
    service: "Deep Cleaning",
    quote: "I am so impressed with Just Shine Cleaning Services! They came out for a deep clean and did an absolutely phenomenal job. They paid attention to details I did not even think of, like wiping down the baseboards.",
    rating: 5,
  },
  {
    ...
    quote: "They are very good in services. They manage the cleanliness and organize things, and they have very good and well-mannered staff. Thanks Just Shine services.",
    rating: 5,
  },
  {
    name: "saif ullah",
    area: "Google review",
    service: "Deep Cleaning",
    quote: "I really appreciate your services especially deep cleaning, house arrangements and kitchen cleaning. The ladies are so professional and well-trained. I recommend everyone to try once.",
    rating: 5,
  },
  {
    name: "Aparna Sathyadas",
    area: "Google review",
    service: "Home Cleaning",
    quote: "I have been a happy and satisfied customer of Just Shine Cleaning Service for almost a year now. Their team is highly professional, punctual, and always understands my needs and requirements.",
    rating: 5,
  },
  {
    name: "Moha Sabir",
  ...
  {
    name: "zhantal bonsato",
    area: "Google review",
    service: "Deep Cleaning",
    quote: "Amazing service especially those deep cleaning.",
    rating: 5,
  },
  {
    name: "Naeem Khan",
  ...
  },
  {
    ...
    quote: "Very good company, all staff, especially Madam Maika, the manager. The best company to deal with, and they are very kind.",
    rating: 5,
  },
  {
