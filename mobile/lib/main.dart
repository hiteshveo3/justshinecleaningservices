...
const palettes = [
  ...
  AppPalette(
    name: 'Leaf Green',
    primary: Color(0xFF2F6F2F),
    accent: Color(0xFFE8F8D9),
    surfaceTint: Color(0xFFF6FBF1),
    background: Color(0xFFF7F9F5),
    ink: Color(0xFF17251A),
    slate: Color(0xFF5E6B5F),
    line: Color(0xFFD8E4D4),
  ),
  AppPalette(
    name: 'Citrus Clean',
    primary: Color(0xFF6F7D12),
    accent: Color(0xFFF6FFD0),
    surfaceTint: Color(0xFFFFFEF2),
    background: Color(0xFFFAFAF2),
    ink: Color(0xFF272911),
    slate: Color(0xFF6D705A),
    line: Color(0xFFE6E8C8),
  ),
  AppPalette(
    name: 'Mint Parrot',
    primary: Color(0xFF3D7A4A),
    accent: Color(0xFFE5FFD8),
    surfaceTint: Color(0xFFF4FFF1),
    background: Color(0xFFF8FBF6),
    ink: Color(0xFF17261A),
    slate: Color(0xFF617066),
    line: Color(0xFFD5E7D2),
  ),
  AppPalette(
    name: 'Deep Parrot',
    primary: Color(0xFF43640E),
    accent: Color(0xFFECF8C9),
    surfaceTint: Color(0xFFF7FBED),
    background: Color(0xFFF6F8F1),
    ink: Color(0xFF202714),
    slate: Color(0xFF616A54),
    line: Color(0xFFDCE5C7),
  ),
];
